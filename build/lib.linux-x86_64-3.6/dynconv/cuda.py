...
__global__ void masked_img2col_forward(
...
def masked_img2col_forward_lanucher(xsparse, w, active_positions_list, active_positions_list_inverted, xshape, stride, padding, dilation, batch_stride=ROUNDING):
